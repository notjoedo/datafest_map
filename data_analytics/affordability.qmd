...
final_csv <- afford_df |> 
  ...
  select(-median_family_income, -state, -case_id, -areaname) |> 
  ...
  select(county, isMetro, family_member_count, YYY, YYN, YNY, NYY, YNN, NYN, NNY, NNN) |> 
  mutate(
  ...
  group_by(numKids, numAdults, Q1, Q2, Q3) |> 
  mutate(
